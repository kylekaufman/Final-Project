...
struct ListingDeletion: Codable {
    let listingId: String
}

struct PublishListingResponse: Codable {
    let data: PublishListingData
}

struct PublishListingData: Codable {
    let publishListingUpdated: Listing2
}

struct Listing2: Codable {
    let listingId: String
    let ownerId: String
    let title: String
    let location: String
